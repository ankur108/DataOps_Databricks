...
The 'Databricks_DataOps' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/Databricks_DataOps/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] Databricks_DataOps_etl` to your workspace.
