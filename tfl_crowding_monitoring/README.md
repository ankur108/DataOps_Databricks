...
The 'tfl_crowding_monitoring' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/tfl_crowding_monitoring/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] tfl_crowding_monitoring_etl` to your workspace.
